...
From the repo root::
    ...
    PYTHONPATH=. python -m world_cup_projects.explain.pass_turnover_explain_run \\
...
from world_cup_projects.explain.pass_explain_visual import (
    PassExplainVideoTiming,
    frames_needed_for_explain,
)
from world_cup_projects.explain.pass_turnover_explain_visual import (
